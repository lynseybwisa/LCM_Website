...
<form action="{{ route('teachers.store') }}" enctype="multipart/form-data" method="POST" class=" container">
    @csrf
    @method('POST')
    <div class="p-4 bg-dark card-sm text-center rounded shadow-lg">
            ...
            <div class="mx-auto">
                <div class="form-group col-auto">
                    <div class="input-group mb-3">
                        ...
                        <select name="sid" class="custom-select" id="student_names">
                ...
                <div class="form-group col-auto text-muted row">
                    ...
                    <div class="input-group col-4 my-2">
                        ...
                        <input type="number" name="eng" max="100" class="form-control" placeholder="" aria-label="English"
                    ...
                    <div class="input-group col-4 my-2">
                        ...
                        <input type="number" name="kis" max="100" class="form-control" placeholder="" aria-label="Kiswahili"
                    ...
                    <div class="input-group col-4 my-2">
                        ...
                        <input type="number"  name="bio" max="100" class="form-control" placeholder="" aria-label="Biology"
                    ...
                    <div class="input-group col-4 my-2">
                        ...
                        <input type="number"  name="che" max="100" class="form-control" placeholder="" aria-label="Chemistry"
                    ...
                    <div class="input-group col-4 my-2">
                        ...
                        <input type="number"  name="phy" max="100" class="form-control" placeholder="" aria-label="Physics"
                    ...
                    <div class="input-group col-4 my-2">
                        ...
                        <input type="number"  name="geo" max="100" class="form-control" placeholder="" aria-label="Geography"
                    ...
                    <div class="input-group col-4 my-2">
                        ...
                        <input type="number"  name="his" max="100" class="form-control" placeholder="" aria-label="History"
                    ...
                    <div class="input-group col-4 my-2">
                        ...
                        <input type="number"  name="bus" max="100" class="form-control" placeholder="" aria-label="Business"
                    ...
                    <div class="input-group col-4 my-2">
                        ...
                        <input type="number"  name="lit" max="100" class="form-control" placeholder="" aria-label="Literature"
                    ...
                    <div class="input-group col-4 my-2">
                        ...
                        <input type="number"  name="he" max="100" class="form-control" placeholder="" aria-label="Home Economics"
                    ...
                    <div class="input-group col-4 my-2">
                        ...
                        <input type="number"  name="and" max="100" class="form-control" placeholder="" aria-label="Art&Design"
        ...
        <button type="submit" class="btn btn-primary">
           Add Report 
           <i class="fa fa-cloud-upload m-2 text-info"></i>
        </button>
    </div>
</form>
