  ...
  <option value="" disabled selected>Nationality</option>
   ...
   <div class="row">
    <div class="col">
      ...
      <input type="Date" name="DOB" class="form-control"  max="2015-01-01"required>
    </div>
    <div class="col">
      <label for="entry_date">Entry Date</label>
     <input type="Date" name="entry_date" class="form-control" min="2020-07-10" required>
    </div>
  </div>
  <div class="row">
    <div class="col">
  ...
  <div class="row">
    <div class="col">
      <label for="school">School</label>
       <select class="form-control" id="school" name="school" class="form-control" required>
