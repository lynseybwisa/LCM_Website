        ...
        <thead>
            ...
            <tr>
                ...
                <th scope="col" class="bg-secondary">
                    <form action="/searchStudentReports" method="POST" role="search">
                        {{ csrf_field() }}
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <button type="button" class="btn btn-tool text-danger">
                        <a href="/teachers"><i class="fas fa-times"></i></a>
                    </button>
                </div>
            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                        <div class="card shadow bg-light">
                            ...
                            <div class="card-footer"> 
                                        <a href="/teachers/studentReport/{{ $student -> id }}"
        ...
        <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
            <div class="card shadow bg-light">
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-12">
                            <a href="/teachers/studentReport/{{ $student -> id }}" class="btn btn-sm btn-secondary">
                                <i class="fas fa-clipboard"></i> Reports
                            </a>
                        </div> 
                    </div>
