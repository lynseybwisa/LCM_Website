...
<head>
    ...
    <title>@yield('title', 'LCM Teachers Portal')</title>
    <!-- Bootstrap 4 -->
            ...
            <div class="navbar-text text-dark">
                <h3>
                    Welcome to <a href="" data-toggle="tooltip" data-placement="bottom" class="text-primary"
                        title="Loreto Convent Msongari">LCM</a><span class="text-primary"> Teachers' Portal</span>
                </h3>
            </div>
            ...
            <div class="sidebar">
                ...
                <nav class="m-1">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="/teachers" class="nav-link font-weight-bold">
                        ...
                        <li class="nav-item">
                            <a href="/teachers/create" class="nav-link font-weight-bold">
                        ...
                        <li class="nav-item">
                            <a href="/teachers/{{ Auth::id() }}" class="nav-link font-weight-bold">
